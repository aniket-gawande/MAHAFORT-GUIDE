...
const VishalgadMap = () => {
  ...
  // Vishalgad Fort coordinates
  const VISHALGAD_FORT = { lat: 16.9583, lng: 73.7486 };

  // Gajapur Village (base village waypoint)
  const GAJAPUR_WAYPOINT = { lat: 16.9550, lng: 73.7500 };
  ...
  useEffect(() => {
    ...
    try {
      ...
      L.marker([VISHALGAD_FORT.lat, VISHALGAD_FORT.lng], { icon: fortIcon })
        .addTo(map)
        .bindPopup(`<strong>🏰 Vishalgad Fort</strong><br/>Historic Maratha Fort<br/>Altitude: 900m<br/><em>"विशालगड" - The Grand Fort</em>`);

      // Add routing with OSRM (FREE!)
      const routingControl = L.Routing.control({
        waypoints: [
          L.latLng(userLocation.lat, userLocation.lng),
          L.latLng(GAJAPUR_WAYPOINT.lat, GAJAPUR_WAYPOINT.lng),
          L.latLng(VISHALGAD_FORT.lat, VISHALGAD_FORT.lng)
        ],
      ...
      const bounds = L.latLngBounds([
        ...
        [VISHALGAD_FORT.lat, VISHALGAD_FORT.lng],
        [GAJAPUR_WAYPOINT.lat, GAJAPUR_WAYPOINT.lng]
      ]);
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <p className="text-yellow-800 text-sm">
              <strong>Note:</strong> Using Kolhapur city center as default. Enable location services for accurate directions from your position.
            </p>
          </div>
        </div>
      )}
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-xl font-bold">Route to Vishalgad Fort</h3>
                <p className="text-sm text-orange-100">via Gajapur Village (Base Village)</p>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border-l-4 border-yellow-500">
        ...
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-start">
            ...
            <span>This route takes you via <strong>Gajapur Village</strong> — the base village of Vishalgad Fort</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>Motorable road available up to the fort entrance, followed by a short walk</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>Nearest city: <strong>Kolhapur (76 km)</strong> — well-connected by road and rail</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>Parking available near the fort entrance (₹20-30)</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>Combine your trip with a visit to nearby <strong>Pavan Khind</strong> memorial</span>
          </li>
        </ul>
      </div>
    </div>
