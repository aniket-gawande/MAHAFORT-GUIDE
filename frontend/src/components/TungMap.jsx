...
const TungMap = () => {
  ...
  // Tung Fort coordinates
  const TUNG_FORT = { lat: 18.6929, lng: 73.4743 };

  // Tungwadi Village (base village waypoint)
  const TUNGWADI_WAYPOINT = { lat: 18.6980, lng: 73.4800 };
  ...
  useEffect(() => {
    ...
    try {
      ...
      L.marker([TUNG_FORT.lat, TUNG_FORT.lng], { icon: fortIcon })
        .addTo(map)
        .bindPopup(`<strong>🏰 Tung Fort (Kathingad)</strong><br/>Maratha Watch Fort<br/>Altitude: 1,075m<br/><em>"तुंग" - The Sentinel of Pawna</em>`);

      // Add routing with OSRM (FREE!)
      const routingControl = L.Routing.control({
        waypoints: [
          L.latLng(userLocation.lat, userLocation.lng),
          L.latLng(TUNGWADI_WAYPOINT.lat, TUNGWADI_WAYPOINT.lng),
          L.latLng(TUNG_FORT.lat, TUNG_FORT.lng)
        ],
      ...
      const bounds = L.latLngBounds([
        ...
        [TUNG_FORT.lat, TUNG_FORT.lng],
        [TUNGWADI_WAYPOINT.lat, TUNGWADI_WAYPOINT.lng]
      ]);
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-xl font-bold">Route to Tung Fort</h3>
                <p className="text-sm text-orange-100">via Tungwadi Village (Base Village)</p>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border-l-4 border-yellow-500">
        ...
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-start">
            ...
            <span>This route takes you via <strong>Tungwadi Village</strong> — the base village of Tung Fort near Pawna Lake</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>The trek involves steep rock-cut steps — wear proper trekking shoes</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>Nearest city: <strong>Lonavala (≈12 km)</strong> — well-connected by road and rail</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>Pawna Lake camping spots are nearby — combine your trip for a weekend getaway</span>
          </li>
          <li className="flex items-start">
            <span className="text-orange-500 mr-2">•</span>
            <span>Combine with visits to nearby <strong>Tikona Fort</strong>, <strong>Lohagad</strong>, and <strong>Visapur Fort</strong></span>
          </li>
        </ul>
      </div>
    </div>
