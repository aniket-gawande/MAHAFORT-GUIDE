          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative group flex justify-center">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl max-w-md w-full">
                <img src={shivaji} alt="Chhatrapati Shivaji Maharaj" className="w-full max-h-[500px] object-contain bg-black/40 transform group-hover:scale-105 transition-transform duration-700" />
